...
public class SettingsActivity extends AppCompatActivity
{
    ...
    private Button btn_status,btn_changeimage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_status = findViewById(R.id.settings_status_btn);
        btn_changeimage = findViewById(R.id.settings_image_btn);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE) {
            ...
            if (resultCode == RESULT_OK) {
                ...
                final StorageReference thumb = mImageStorage.child("profile_images").child("thumbs").child(current_uid + ".jpg");
                ...
                filepath.putFile(resultUri).addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                        if(task.isSuccessful()){
                            ...
                            UploadTask uploadTask = thumb.putBytes(thumb_byte);
